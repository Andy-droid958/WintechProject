...
const Projects = () => {
  ...
  const albumOverrides = {
    ...
    album4: { title: ' D’LATOUR', services: 'Aluminium Composite Panel', description: '' },
    album5: { title: 'DENAI RESIDENCE - 228 UNITS', services: 'Aluminium Composite Panel', description: '' },
    ...
    album15: { title: 'MPPJ BUILDING', services: 'Aluminium Composite Panel', description: '' },
    ...
    album21: { title: 'SANCTUARY MALL', services: 'Aluminium Composite Panel', description: '' },
    ...
    album30: { title: 'TAMAN TUN SHELL PETROL STATION', services: 'Aluminium Composite Panel', description: '' },
  }
